/**
 * Database Schema for DropX
 *
 * This file defines the database structure for our DropX application.
 ...
 * Files Table
 *
 * This table stores all files and folders in our DropX.
...
export const files = pgTable("files", {
    ...
    path: text("path").notNull(), // Full path to the file/folder --> mainly for imagekit like /doc/proj/resume.pdf
